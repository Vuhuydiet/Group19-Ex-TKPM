...
function RegisterList() {
    ...
    return (
        <>
            {/* {selectCourseEnrollment && <StudentItem selectCourseEnrollment={selectCourseEnrollment} setSelectCourseEnrollment={setSelectCourseEnrollment} courseEnrollment={courseEnrollment} setCourseEnrollment={setCourseEnrollment} />} */}
            {isAddFormOpen && <Register setIsHide={setIsAddFormOpen} />}
            {/* <AddForm setIsAddFormOpen={setIsAddFormOpen} courseEnrollment={courseEnrollment} setCourseEnrollment={setCourseEnrollment} /> */}
